        ...
        <div className="space-y-4">
          ...
          <div className="border-t border-club-border pt-4">
            ...
            <div className="space-y-3">
              ...
              <div>
                <label className="block text-xs text-gray-400 uppercase tracking-wide mb-1.5">OG Image (iMessage / Social Preview)</label>
                <p className="text-xs text-gray-600 mb-3">The image shown when sharing your link on iMessage, Twitter, Slack, etc. PNG or JPG, 1200×630px recommended.</p>
                {ogImageUrl && (
                  <div className="rounded border border-club-border overflow-hidden bg-black mb-3" style={{ height: 120 }}>
                ...
                {ogImageUrl && <p className="text-xs text-gray-600 mt-1.5 truncate">{ogImageUrl}</p>}
              </div>
            </div>
          </div>
        </div>
